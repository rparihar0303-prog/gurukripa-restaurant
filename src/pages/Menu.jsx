...
const menuData = [
  {
    category: "🌟 Must Try",
    items: [
      { name: "Dal Bafle Special Thali", desc: "Traditional Rajasthani thali with dal bafle & churma — House Specialty!", price: 350, image: "/DalBati.png" },
      { name: "Paneer Butter Masala", desc: "Rich and creamy dish made of mildly sweet gravy with butter, cashew paste, tomato gravy and traditional spices", price: 294, image: "/PaneerButterMasala.jpg" },
      { name: "Malai Kofta", desc: "Celebratory dish — cashew and vegetables stuffed cottage cheese dumplings in a sweet saffron cream gravy", price: 286, image: "/MalaiKofta.jpg" },
      { name: "Today Special Paneer", desc: "Gurukripa style rich, very flavorful & delicious paneer dish in yello gravy — big paneer pieces!", price: 363, image: "/SpecialPanner.jpg" },
      { name: "Veg Biryani", desc: "Rice and veggies cooked in fragrant masala seasoned with Indian whole spices, served with raita", price: 226, image: "/VegBiryani.webp" },
      { name: "Crispy Corn", desc: "Fresh corn kernels deep fried and flavoured with white pepper, rock salt, spring onions and capsicum", price: 269, image: "/CrispyCorn.jpg" },
    ],
  },
  {
    category: "Starters & Snacks",
    items: [
      { name: "Paneer Tikka Dry (6 Pcs)", desc: "Cottage cheese slices marinated with barbeque seasoning and roasted in tandoor to a light crispiness", price: 320, image: "/PannerTikka.jpg" },
      { name: "Hara Bhara Kabab", desc: "Nutritious vegetarian kebab made with fresh spinach and green peas. Served with mint chutney", price: 252, image: "/HaraBharaKabab.jpg" },
      { name: "Honey Chilli Potato", desc: "Potato strips fried to perfection and slathered in honey chilli sauce topped with sesame seeds", price: 269, image: "/HoneyChilliPotato.jpg" },
      { name: "Veg Manchurian", desc: "Indo Chinese favourite — fresh veggies cooked in tangy Manchurian sauce", price: 269, image: "/Manchurian.jpg" },
      { name: "Chilli Paneer", desc: "Crispy paneer with garlic, onions, green chillies tossed in soya sauce and home made chili sauce", price: 314, image: "/ChilliPaneer.jpg" },
      { name: "Veg Lollipop", desc: "Flavourful sticks made of chopped vegetables and spices blend together fried deep to a lip smacking taste", price: 177, image: "/VegLolipop.jpg" },
    ],
  },
  {
    category: "Soups & Salads",
    items: [
      { name: "Tomato Soup", desc: "Classic creamy tomato soup", price: 276, image: "/TomatoSoup.jpg" },
      { name: "Sweet Corn Soup", desc: "Thick sweet corn soup with vegetables", price: 164, image: "/SweetCornSoup.jpg" },
      { name: "Hot & Sour Soup", desc: "Hot and sour soup made from juicy fresh assorted vegetables with special blend of Indian spices", price: 164, image: "/Hot&SourSoup.jpg" },
    ],
  },
  {
    category: "Main Course — Paneer",
    items: [
      { name: "Shahi Paneer", desc: "Cubes of paneer simmered in a creamy curry with mild and sweet undertones of whole spices", price: 294, image: "/ShahiPaneer.jpg" },
      { name: "Kadai Paneer", desc: "Paneer chunks in spicy kadhai masala flavors with toppings of onion and capsicum", price: 304, image: "/KadaiPaneer.jpg" },
      { name: "Palak Paneer", desc: "Juicy chunks of paneer cooked in creamy gravy with nutritious spinach", price: 279, image: "/PalakPaneer.jpg" },
      { name: "Paneer Tikka Masala", desc: "Marinated cottage cheese grilled to perfection and cooked in tomato-onion based curry", price: 295, image: "/PaneerTikkaMasala.jpg" },
      { name: "Paneer Handi", desc: "Cottage cheese and onions stir fried and tossed in a mildly spiced masala", price: 311, image: "/PannerHandi.jpeg" },
    ],
  },
  {
    category: "Main Course — Veg & Dal",
    items: [
      { name: "Dal Makhani", desc: "Black lentil slow-cooked in a creamy, buttery and slightly spicy gravy", price: 244, image: "/DalMakhani.jpg" },
      { name: "Dal Tadka", desc: "Flavourful dal made with boiled yellow lentil, tomatoes, onions tempered with spices", price: 226, image: "/DalTadka.webp" },
      { name: "Veg Kolhapuri", desc: "Delicious, spicy & flavorful dish made with vegetables, onions, tomatoes, ginger, garlic & fresh ground spices", price: 269, image: "/VegKolhapuri.jpg" },
      { name: "Navratan Korma", desc: "Exotic Indian recipe of assorted vegetables tossed in creamy spiced sauce", price: 286, image: "/NavratanKorma.jpg" },
      { name: "Veg Patiala", desc: "Aromatic mixture of vegetables in incredible curry sauce made with paneer, tomato, onion and spices", price: 337, image: "/VegPatiala.jpg" },
    ],
  },
  {
    category: "Rice & Breads",
    items: [
      { name: "Special Dum Biryani", desc: "Aromatic dum-cooked biryani with fresh vegetables and whole spices", price: 320, image: "/DumBiryani.jpg" },
      { name: "Jeera Rice", desc: "Aromatic basmati rice cooked with cumin and flavourful spices", price: 150, image: "/JeeraRice.jpg" },
      { name: "Butter Naan", desc: "Soft leavened bread brushed with butter from tandoor", price: 89, image: "/ButterNaan.jpg" },
      { name: "Garlic Naan", desc: "Tandoor-baked naan with fresh garlic & butter", price: 115, image: "/GarlicNaan.jpg" },
      { name: "Tandoori Roti", desc: "Classic tandoor-baked whole wheat roti", price: 19, image: "/TandooriRoti.jpg" },
    ],
  },
  {
    category: "Sweets & Drinks",
    items: [
      { name: "Gulab Jamun", desc: "Sweet dumplings made with maida and kova, soaked in sugar syrup", price: 220, image: "/GulabJamun.jpg" },
      { name: "Rasmalai (2 Piece)", desc: "Flattened balls of chhana soaked in malai flavoured with cardamom", price: 160, image: "/Rasmalai.jpg" },
      { name: "Lassi", desc: "Thick chilled yogurt-based traditional drink", price: 65, image: "/Lassi.webp" },
      { name: "Jaljeera", desc: "Cooling cumin-based traditional digestive drink", price: 45, image: "/Jaljeera.webp" },
    ],
  },
];
